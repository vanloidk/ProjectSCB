...
public class WSBeanServiceLocator extends org.apache.axis.client.Service implements scb.com.vn.ws.gatewayscb.WSBeanService {
    ...
    private java.lang.String WSBean_address = "http://localhost:8080/ebankgw_svr/services/WSBean";
    ...
    public scb.com.vn.ws.gatewayscb.WSBean getWSBean(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            scb.com.vn.ws.gatewayscb.WSBeanSoapBindingStub _stub = new scb.com.vn.ws.gatewayscb.WSBeanSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (scb.com.vn.ws.gatewayscb.WSBean.class.isAssignableFrom(serviceEndpointInterface)) {
                scb.com.vn.ws.gatewayscb.WSBeanSoapBindingStub _stub = new scb.com.vn.ws.gatewayscb.WSBeanSoapBindingStub(new java.net.URL(WSBean_address), this);
                _stub.setPortName(getWSBeanWSDDServiceName());
                return _stub;
            }
        }
