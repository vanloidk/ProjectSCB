...
public class Transfer247Request {
    ...
    String FullName; // Ten nguoi chuyen
    String Address; // Dia chi nguoi chuyen 
    String ToNumber;
    String TypeToNumber; //ACCCOUNT/CARD
    String BenID;
    BigDecimal Amount;
    String CCY;
    String Channel;  //EBANK/MB/COUNTER1/COUNTER2/COUNTER3/ATM/CRM1/CRM2/CMR3
    String Desc; // Noi dung ck
    String TypeFunction; //QUE/TRN
    String TransID; // MA GD
    String TransDate; // Ngay GD
    String UserMaker;
    String UserChecker;
    String Branch;
    String IdCard;// so cmnd
    String IdCardDob; // ngap cap
    String IDCardAddress; //Noi cap
