...
public class PartnerHistoryTransferResp implements java.io.Serializable {
    ...
    private String MAC;
    private List<transHistoryDtl> transHistoryDtl;
    ...
    @XmlElement(name = "TRANSHISTORYDETAIL", nillable = true)
    public List<transHistoryDtl> getTransHistoryDtl() {
        return transHistoryDtl;
    }

    public void setTransHistoryDtl(List<transHistoryDtl> transHistoryDtl) {
        this.transHistoryDtl = transHistoryDtl;
    }
     ...
     * Dto02
     */
    public static class transHistoryDtl {
