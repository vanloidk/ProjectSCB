 ...
 * @author KimNCM
 */
@XmlRootElement(name = "GetPrimaryCardListRp")
public class GetPrimaryCardListRp extends MobileResponse {
     ...
     *
     */
    public GetPrimaryCardListRp() {
    }

    /**
     * @return the _ListCard
     */
    @XmlElement(name = "ATMCardDetail")
    @XmlElementWrapper(name = "ListATMCard", nillable = true)
