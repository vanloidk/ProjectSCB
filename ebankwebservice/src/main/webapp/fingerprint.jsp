...
<html>
    ...
    <body bgcolor=#ffffff>
        <%!    /*
            ...
            /**
             * Identify the version of a jar file. This uses a properties file containing known names and sizes in the format 'name(size)=version'. Version
             * strings should be like 'xerces-1.4' ie they should include the name of the library.
             */
            ...
            /**
             * Split up a classpath-like variable. Returns a list of files. TODO: this can't cope with relative paths. I think theres code in BCEL that can be
             * used for this?
             */
