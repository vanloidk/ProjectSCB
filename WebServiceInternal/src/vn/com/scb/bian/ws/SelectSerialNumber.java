...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  SelectSerialNumber bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SelectSerialNumber
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":selectSerialNumber",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "selectSerialNumber",
    ...
    public static class Factory{
        ...
        */
        public static SelectSerialNumber parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SelectSerialNumber object =
                new SelectSerialNumber();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"selectSerialNumber".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SelectSerialNumber)vn.com.scb.bian.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
