...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  BlockReleaseSerialNumber bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BlockReleaseSerialNumber
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "bian.scb.com.vn",
                "blockReleaseSerialNumber",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":blockReleaseSerialNumber",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "blockReleaseSerialNumber",
    ...
    public static class Factory{
        ...
        */
        public static BlockReleaseSerialNumber parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BlockReleaseSerialNumber object =
                new BlockReleaseSerialNumber();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"blockReleaseSerialNumber".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BlockReleaseSerialNumber)vn.com.scb.bian.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","in").equals(reader.getName()) || new javax.xml.namespace.QName("","in").equals(reader.getName()) ){
