...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  PublishSerialNumber bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PublishSerialNumber
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":publishSerialNumber",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "publishSerialNumber",
    ...
    public static class Factory{
        ...
        */
        public static PublishSerialNumber parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PublishSerialNumber object =
                new PublishSerialNumber();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"publishSerialNumber".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PublishSerialNumber)vn.com.scb.bian.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
