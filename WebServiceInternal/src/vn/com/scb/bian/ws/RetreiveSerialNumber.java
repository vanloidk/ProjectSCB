...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  RetreiveSerialNumber bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RetreiveSerialNumber
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "bian.scb.com.vn",
                "retreiveSerialNumber",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":retreiveSerialNumber",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "retreiveSerialNumber",
    ...
    public static class Factory{
        ...
        */
        public static RetreiveSerialNumber parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RetreiveSerialNumber object =
                new RetreiveSerialNumber();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"retreiveSerialNumber".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RetreiveSerialNumber)vn.com.scb.bian.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
