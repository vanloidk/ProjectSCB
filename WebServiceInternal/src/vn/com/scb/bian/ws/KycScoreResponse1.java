...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  KycScoreResponse1 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class KycScoreResponse1
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":kycScoreResponse1",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "kycScoreResponse1",
    ...
    public static class Factory{
        ...
        */
        public static KycScoreResponse1 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            KycScoreResponse1 object =
                new KycScoreResponse1();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"kycScoreResponse1".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (KycScoreResponse1)vn.com.scb.bian.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
