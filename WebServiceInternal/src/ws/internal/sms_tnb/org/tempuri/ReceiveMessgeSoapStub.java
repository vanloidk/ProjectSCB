...
public class ReceiveMessgeSoapStub extends org.apache.axis.client.Stub implements ws.internal.sms_tnb.org.tempuri.ReceiveMessgeSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("http://tempuri.org/", "messageReceiverResult"));
    ...
    public ReceiveMessgeSoapStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public ReceiveMessgeSoapStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public ReceiveMessgeSoapStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public java.lang.String messageReceiver(java.lang.String userID, java.lang.String serviceID, java.lang.String message, java.lang.String moID, java.lang.String username, java.lang.String password) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://tempuri.org/messageReceiver");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://tempuri.org/", "messageReceiver"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {userID, serviceID, message, moID, username, password});
