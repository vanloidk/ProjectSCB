...
public class ServiceLocator extends org.apache.axis.client.Service implements ws.internal.tokenkey.scb.Service {
...
//    private java.lang.String ServiceSoap_address = "http://10.254.2.13:8011/service.asmx";
    private java.lang.String ServiceSoap_address = "http://192.168.1.13:8011/service.asmx";
    ...
    public ws.internal.tokenkey.scb.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.internal.tokenkey.scb.ServiceSoapStub _stub = new ws.internal.tokenkey.scb.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.internal.tokenkey.scb.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.internal.tokenkey.scb.ServiceSoapStub _stub = new ws.internal.tokenkey.scb.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
