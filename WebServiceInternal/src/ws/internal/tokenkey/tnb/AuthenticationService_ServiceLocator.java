...
public class AuthenticationService_ServiceLocator extends org.apache.axis.client.Service implements ws.internal.tokenkey.tnb.AuthenticationService_Service {
    ...
    private java.lang.String AuthenticationService_address = "http://192.168.13.1:8080/IdentityGuardAuthService/services/AuthenticationServiceV5";
    ...
    public ws.internal.tokenkey.tnb.AuthenticationService_PortType getAuthenticationService() throws javax.xml.rpc.ServiceException {
    ...
    public ws.internal.tokenkey.tnb.AuthenticationService_PortType getAuthenticationService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.internal.tokenkey.tnb.AuthenticationServiceSoapBindingStub _stub = new ws.internal.tokenkey.tnb.AuthenticationServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.internal.tokenkey.tnb.AuthenticationService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.internal.tokenkey.tnb.AuthenticationServiceSoapBindingStub _stub = new ws.internal.tokenkey.tnb.AuthenticationServiceSoapBindingStub(new java.net.URL(AuthenticationService_address), this);
                _stub.setPortName(getAuthenticationServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:entrust.com:ig:authenticationV5:wsdl", "AuthenticationService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:entrust.com:ig:authenticationV5:wsdl", "AuthenticationService"));
        }
