...
public class WSBeanServiceLocator extends org.apache.axis.client.Service implements ws.internal.payment.payoo.navigation.WSBeanService {
    ...
    private java.lang.String WSBean_address = "http://localhost:8084/ebankwebservice_payoo/services/WSBean";
    ...
    public ws.internal.payment.payoo.navigation.WSBean getWSBean() throws javax.xml.rpc.ServiceException {
    ...
    public ws.internal.payment.payoo.navigation.WSBean getWSBean(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.internal.payment.payoo.navigation.WSBeanSoapBindingStub _stub = new ws.internal.payment.payoo.navigation.WSBeanSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.internal.payment.payoo.navigation.WSBean.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.internal.payment.payoo.navigation.WSBeanSoapBindingStub _stub = new ws.internal.payment.payoo.navigation.WSBeanSoapBindingStub(new java.net.URL(WSBean_address), this);
                _stub.setPortName(getWSBeanWSDDServiceName());
                return _stub;
            }
        }
