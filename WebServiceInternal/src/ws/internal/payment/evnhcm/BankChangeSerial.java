...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  BankChangeSerial bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BankChangeSerial
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        */
                                    ...
                                    protected java.lang.String localMaHD ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localMaHDTracker = false ;

                           public boolean isMaHDSpecified(){
                               return localMaHDTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getMaHD(){
                               return localMaHD;
                           }
                            ...
                            /**
                               ...
                               * @param param MaHD
                               */
                               public void setMaHD(java.lang.String param){
                            localMaHDTracker = param != null;
                                   
                                            this.localMaHD=param;
                        ...
                        */
                        ...
                        /**
                        * field for MaGiaoDichMoi
                        */

                        
                                    protected java.lang.String localMaGiaoDichMoi ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localMaGiaoDichMoiTracker = false ;

                           public boolean isMaGiaoDichMoiSpecified(){
                               return localMaGiaoDichMoiTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getMaGiaoDichMoi(){
                               return localMaGiaoDichMoi;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param MaGiaoDichMoi
                               */
                               public void setMaGiaoDichMoi(java.lang.String param){
                            localMaGiaoDichMoiTracker = param != null;
                                   
                                            this.localMaGiaoDichMoi=param;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":BankChangeSerial",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "BankChangeSerial",
                ...
                if (localMaKHTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "http://tempuri.org/";
                                    writeStartElement(null, namespace, "MaHD", xmlWriter);
                             

                                          if (localMaHD==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("MaHD cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localMaHD);
                              ...
                              if (localMaGiaoDichTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localMaGiaoDichMoiTracker){
                                    namespace = "http://tempuri.org/";
                                    writeStartElement(null, namespace, "MaGiaoDichMoi", xmlWriter);
                             

                                          if (localMaGiaoDichMoi==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("MaGiaoDichMoi cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localMaGiaoDichMoi);
    ...
    public static class Factory{
        ...
        */
        public static BankChangeSerial parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BankChangeSerial object =
                new BankChangeSerial();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"BankChangeSerial".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BankChangeSerial)ws.internal.payment.evnhcm.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","MaHD").equals(reader.getName()) || new javax.xml.namespace.QName("","MaHD").equals(reader.getName()) ){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"MaHD" +"  cannot be null");
                                    }
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://tempuri.org/","MaGiaoDichMoi").equals(reader.getName()) || new javax.xml.namespace.QName("","MaGiaoDichMoi").equals(reader.getName()) ){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"MaGiaoDichMoi" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setMaGiaoDichMoi(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
