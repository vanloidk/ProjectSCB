...
import javax.xml.stream.XMLStreamReader;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":BankCheckConfirm",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "BankCheckConfirm",
    ...
    public static class Factory{
        ...
        */
        public static BankCheckConfirm parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BankCheckConfirm object =
                new BankCheckConfirm();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"BankCheckConfirm".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BankCheckConfirm)ws.internal.payment.evnhcm.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
