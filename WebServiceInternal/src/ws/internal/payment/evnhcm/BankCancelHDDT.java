...
import javax.xml.stream.XMLStreamReader;
            ...
            /**
            *  BankCancelHDDT bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BankCancelHDDT
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":BankCancelHDDT",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "BankCancelHDDT",
    ...
    public static class Factory{
        ...
        */
        public static BankCancelHDDT parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BankCancelHDDT object =
                new BankCancelHDDT();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"BankCancelHDDT".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BankCancelHDDT)ws.internal.payment.evnhcm.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
