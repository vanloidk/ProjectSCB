...
public class WSBeanServiceLocator extends org.apache.axis.client.Service implements ws.internal.payment.onepay.WSBeanService {
    ...
    private java.lang.String WSBean_address = "http://localhost:8084/ebankwebservice_onepay/services/WSBean";
    ...
    public ws.internal.payment.onepay.WSBean getWSBean(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.internal.payment.onepay.WSBeanSoapBindingStub _stub = new ws.internal.payment.onepay.WSBeanSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.internal.payment.onepay.WSBean.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.internal.payment.onepay.WSBeanSoapBindingStub _stub = new ws.internal.payment.onepay.WSBeanSoapBindingStub(new java.net.URL(WSBean_address), this);
                _stub.setPortName(getWSBeanWSDDServiceName());
                return _stub;
            }
        }
