...
public class CheckBillResponse  implements java.io.Serializable {
    private ws.internal.payment.evnspc.CheckBillResponseCheckBillResult checkBillResult;

    public CheckBillResponse() {
    }

    public CheckBillResponse(
           ws.internal.payment.evnspc.CheckBillResponseCheckBillResult checkBillResult) {
     ...
     */
    public ws.internal.payment.evnspc.CheckBillResponseCheckBillResult getCheckBillResult() {
        return checkBillResult;
    }
     ...
     */
    public void setCheckBillResult(ws.internal.payment.evnspc.CheckBillResponseCheckBillResult checkBillResult) {
        this.checkBillResult = checkBillResult;
    }
