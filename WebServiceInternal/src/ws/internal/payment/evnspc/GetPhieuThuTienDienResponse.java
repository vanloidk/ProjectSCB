...
public class GetPhieuThuTienDienResponse  implements java.io.Serializable {
    private ws.internal.payment.evnspc.GetPhieuThuTienDienResponseGetPhieuThuTienDienResult getPhieuThuTienDienResult;

    public GetPhieuThuTienDienResponse() {
    }

    public GetPhieuThuTienDienResponse(
           ws.internal.payment.evnspc.GetPhieuThuTienDienResponseGetPhieuThuTienDienResult getPhieuThuTienDienResult) {
     ...
     */
    public ws.internal.payment.evnspc.GetPhieuThuTienDienResponseGetPhieuThuTienDienResult getGetPhieuThuTienDienResult() {
        return getPhieuThuTienDienResult;
    }
     ...
     */
    public void setGetPhieuThuTienDienResult(ws.internal.payment.evnspc.GetPhieuThuTienDienResponseGetPhieuThuTienDienResult getPhieuThuTienDienResult) {
        this.getPhieuThuTienDienResult = getPhieuThuTienDienResult;
    }
