...
public class WSBeanServiceLocator extends org.apache.axis.client.Service implements ws.internal.payment.vnpay.navigation.WSBeanService {
    ...
    private java.lang.String WSBean_address = "http://localhost:8080/ebankwebservice_vnpay/services/WSBean";
    ...
    public ws.internal.payment.vnpay.navigation.WSBean getWSBean() throws javax.xml.rpc.ServiceException {
    ...
    public ws.internal.payment.vnpay.navigation.WSBean getWSBean(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.internal.payment.vnpay.navigation.WSBeanSoapBindingStub _stub = new ws.internal.payment.vnpay.navigation.WSBeanSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.internal.payment.vnpay.navigation.WSBean.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.internal.payment.vnpay.navigation.WSBeanSoapBindingStub _stub = new ws.internal.payment.vnpay.navigation.WSBeanSoapBindingStub(new java.net.URL(WSBean_address), this);
                _stub.setPortName(getWSBeanWSDDServiceName());
                return _stub;
            }
        }
