...
public class ServiceLocator extends org.apache.axis.client.Service implements ws.internal.tnb.checkpass.tempuri.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://192.168.15.4/Service.asmx";
    ...
    public ws.internal.tnb.checkpass.tempuri.ServiceSoap getServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public ws.internal.tnb.checkpass.tempuri.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ws.internal.tnb.checkpass.tempuri.ServiceSoapStub _stub = new ws.internal.tnb.checkpass.tempuri.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ws.internal.tnb.checkpass.tempuri.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                ws.internal.tnb.checkpass.tempuri.ServiceSoapStub _stub = new ws.internal.tnb.checkpass.tempuri.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
