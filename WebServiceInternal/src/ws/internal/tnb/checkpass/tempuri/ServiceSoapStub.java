...
public class ServiceSoapStub extends org.apache.axis.client.Stub implements ws.internal.tnb.checkpass.tempuri.ServiceSoap {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnQName(new javax.xml.namespace.QName("http://tempuri.org/", "CheckPassResult"));
    ...
    public boolean checkPass(java.lang.String username, java.lang.String password, java.lang.String IP) throws java.rmi.RemoteException {
        ...
        _call.setSOAPActionURI("http://tempuri.org/CheckPass");
        _call.setEncodingStyle(null);
        _call.setProperty(org.apache.axis.client.Call.SEND_TYPE_ATTR, Boolean.FALSE);
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://tempuri.org/", "CheckPass"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {username, password, IP});
