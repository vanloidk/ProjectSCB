/**
 * RetrieveLoanSumary_in_Type.java
 *
...
public class RetrieveLoanSumary_in_Type  implements java.io.Serializable {
    private vn.com.scb.bian.TransactionInfoType transactionInfo;

    private vn.com.scb.bian.LoanAccountInfoType loanAccountInfo;

    
    public RetrieveLoanSumary_in_Type() {
    }
   
    // Add a container for the root element
    public static class Container {
        public RetrieveLoanSumary_in_Type retrieveLoanSumary_in;
    }
    ...
    /**
     * Gets the transactionInfo value for this RetrieveLoanSumary_in_Type.
     * 
    ...
    /**
     * Sets the transactionInfo value for this RetrieveLoanSumary_in_Type.
     * 
    ...
    /**
     * Gets the loanAccountInfo value for this RetrieveLoanSumary_in_Type.
     * 
    ...
    /**
     * Sets the loanAccountInfo value for this RetrieveLoanSumary_in_Type.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveLoanSumary_in_Type)) return false;
        RetrieveLoanSumary_in_Type other = (RetrieveLoanSumary_in_Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveLoanSumary_in_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("bian.scb.com.vn", "retrieveLoanSumary_in_Type"));
