/**
 * InitiateDepositAccountTD_out_type.java
 *
...
public class InitiateDepositAccountTD_out_type  implements java.io.Serializable {
    private vn.com.scb.bian.AccountInfoType accountInfo;

    private vn.com.scb.bian.TransactionInfoType transactionInfo;

    public InitiateDepositAccountTD_out_type() {
    }

    public static class Container {
        public InitiateDepositAccountTD_out_type initiateDepositAccountTD_out;
    }
    ...
    /**
     * Gets the accountInfo value for this InitiateDepositAccountTD_out_type.
     * 
     * @return accountInfo
     */
    ...
    /**
     * Sets the accountInfo value for this InitiateDepositAccountTD_out_type.
     * 
     * @param accountInfo
     */
    ...
    /**
     * Gets the transactionInfo value for this InitiateDepositAccountTD_out_type.
     * 
    ...
    /**
     * Sets the transactionInfo value for this InitiateDepositAccountTD_out_type.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof InitiateDepositAccountTD_out_type)) return false;
        InitiateDepositAccountTD_out_type other = (InitiateDepositAccountTD_out_type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(InitiateDepositAccountTD_out_type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("bian.scb.com.vn", "initiateDepositAccountTD_out_type"));
