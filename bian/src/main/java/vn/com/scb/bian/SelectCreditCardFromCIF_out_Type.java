/**
 * SelectCreditCardFromCIF_out_Type.java
 *
...
public class SelectCreditCardFromCIF_out_Type  implements java.io.Serializable {
    private vn.com.scb.bian.TransactionInfoType transactionInfo;

    private vn.com.scb.bian.CardInfoType cardInfo;

    public SelectCreditCardFromCIF_out_Type() {
    }

      // Add a container for the root element
    public static class Container {
        public SelectCreditCardFromCIF_out_Type selectCreditCardFromCIF_out;
    }
    ...
    /**
     * Gets the transactionInfo value for this SelectCreditCardFromCIF_out_Type.
     * 
    ...
    /**
     * Sets the transactionInfo value for this SelectCreditCardFromCIF_out_Type.
     * 
    ...
    /**
     * Gets the cardInfo value for this SelectCreditCardFromCIF_out_Type.
     * 
     * @return cardInfo
     */
    ...
    /**
     * Sets the cardInfo value for this SelectCreditCardFromCIF_out_Type.
     * 
     * @param cardInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SelectCreditCardFromCIF_out_Type)) return false;
        SelectCreditCardFromCIF_out_Type other = (SelectCreditCardFromCIF_out_Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SelectCreditCardFromCIF_out_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("bian.scb.com.vn", "selectCreditCardFromCIF_out_Type"));
