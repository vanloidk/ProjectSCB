/**
 * RetrieveDepositAccountTD_in_Type.java
 *
...
public class RetrieveDepositAccountTD_in_Type  implements java.io.Serializable {
    private vn.com.scb.bian.TransactionInfoType transactionInfo;

    private vn.com.scb.bian.AccountInfoType accountInfo;

    public RetrieveDepositAccountTD_in_Type() {
    }

    // Add a container for the root element
    public static class Container {
        public RetrieveDepositAccountTD_in_Type retrieveDepositAccountTD_in;
    }
    ...
    /**
     * Gets the transactionInfo value for this RetrieveDepositAccountTD_in_Type.
     * 
    ...
    /**
     * Sets the transactionInfo value for this RetrieveDepositAccountTD_in_Type.
     * 
    ...
    /**
     * Gets the accountInfo value for this RetrieveDepositAccountTD_in_Type.
     * 
     * @return accountInfo
     */
    ...
    /**
     * Sets the accountInfo value for this RetrieveDepositAccountTD_in_Type.
     * 
     * @param accountInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveDepositAccountTD_in_Type)) return false;
        RetrieveDepositAccountTD_in_Type other = (RetrieveDepositAccountTD_in_Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveDepositAccountTD_in_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("bian.scb.com.vn", "retrieveDepositAccountTD_in_Type"));
