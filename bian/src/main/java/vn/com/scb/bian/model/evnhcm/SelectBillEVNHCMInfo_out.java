...
import vn.com.scb.bian.model.evnhn.GetBillInfo_out;

/**
 *
 * @author minhndb
 */
public class SelectBillEVNHCMInfo_out implements Serializable {
    ...
    public void setGetBillInfo_out(GetBillInfo_out getBillInfo_out) {
        this.getBillInfo_out = getBillInfo_out;
    }
