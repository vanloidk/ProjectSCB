/**
 * TerminateCurrentAccount_out_Type.java
 *
...
public class TerminateCurrentAccount_out_Type  implements java.io.Serializable {
    private vn.com.scb.bian.TransactionInfoType transactionInfo;

    private vn.com.scb.bian.AccountInfoType accountInfo;

    public TerminateCurrentAccount_out_Type() {
    }
    ...
    /**
     * Gets the transactionInfo value for this TerminateCurrentAccount_out_Type.
     * 
    ...
    /**
     * Sets the transactionInfo value for this TerminateCurrentAccount_out_Type.
     * 
    ...
    /**
     * Gets the accountInfo value for this TerminateCurrentAccount_out_Type.
     * 
     * @return accountInfo
     */
    ...
    /**
     * Sets the accountInfo value for this TerminateCurrentAccount_out_Type.
     * 
     * @param accountInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TerminateCurrentAccount_out_Type)) return false;
        TerminateCurrentAccount_out_Type other = (TerminateCurrentAccount_out_Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TerminateCurrentAccount_out_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("bian.scb.com.vn", "terminateCurrentAccount_out_Type"));
