/**
 * ExecutePaymentTransactionExternal_in_Type.java
 *
...
public class ExecutePaymentTransactionExternal_in_Type  implements java.io.Serializable {
    ...
    public ExecutePaymentTransactionExternal_in_Type() {
    }
    
      // Add a container for the root element
    public static class Container {
        public ExecutePaymentTransactionExternal_in_Type executePaymentTransactionExternal_in;
    }
    ...
    /**
     * Gets the transactionInfo value for this ExecutePaymentTransactionExternal_in_Type.
     * 
    ...
    /**
     * Sets the transactionInfo value for this ExecutePaymentTransactionExternal_in_Type.
     * 
    ...
    /**
     * Gets the fundTransferInfo value for this ExecutePaymentTransactionExternal_in_Type.
     * 
    ...
    /**
     * Sets the fundTransferInfo value for this ExecutePaymentTransactionExternal_in_Type.
     * 
    ...
    /**
     * Gets the sourceAccount value for this ExecutePaymentTransactionExternal_in_Type.
     * 
    ...
    /**
     * Sets the sourceAccount value for this ExecutePaymentTransactionExternal_in_Type.
     * 
     * @param sourceAccount
     */
    ...
    /**
     * Gets the destinationAccount value for this ExecutePaymentTransactionExternal_in_Type.
     * 
    ...
    /**
     * Sets the destinationAccount value for this ExecutePaymentTransactionExternal_in_Type.
     * 
    ...
    /**
     * Gets the benificialInfo value for this ExecutePaymentTransactionExternal_in_Type.
     * 
    ...
    /**
     * Sets the benificialInfo value for this ExecutePaymentTransactionExternal_in_Type.
     * 
    ...
    /**
     * Gets the senderInfo value for this ExecutePaymentTransactionExternal_in_Type.
     * 
     * @return senderInfo
     */
    ...
    /**
     * Sets the senderInfo value for this ExecutePaymentTransactionExternal_in_Type.
     * 
     * @param senderInfo
     */
    ...
    /**
     * Gets the coreBankAccount value for this ExecutePaymentTransactionExternal_in_Type.
     * 
    ...
    /**
     * Sets the coreBankAccount value for this ExecutePaymentTransactionExternal_in_Type.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExecutePaymentTransactionExternal_in_Type)) return false;
        ExecutePaymentTransactionExternal_in_Type other = (ExecutePaymentTransactionExternal_in_Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExecutePaymentTransactionExternal_in_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("bian.scb.com.vn", "executePaymentTransactionExternal_in_Type"));
