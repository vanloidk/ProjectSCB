...
import vn.com.scb.bian.model.evnhn.PayBill_out;

/**
 *
 * @author minhndb
 */
public class PayBillEVNHCM_out implements Serializable {
    ...
    public String getBillMoreInformation() {
        try {
            return payBill_out.getBillPaymentInfo().getBillMoreInfomation();
        } catch (Exception e) {
            return "";
        }
    }
