/**
 * RetrieveDepositAccountTD_out_Type.java
 *
...
public class RetrieveDepositAccountTD_out_Type  implements java.io.Serializable {
    private vn.com.scb.bian.TransactionInfoType transactionInfo;

    private vn.com.scb.bian.AccountInfoType accountInfo;

    public RetrieveDepositAccountTD_out_Type() {
    }

    // Add a container for the root element
    public static class Container {
        public RetrieveDepositAccountTD_out_Type retrieveDepositAccountTD_out;
    }
    ...
    /**
     * Gets the transactionInfo value for this RetrieveDepositAccountTD_out_Type.
     * 
    ...
    /**
     * Sets the transactionInfo value for this RetrieveDepositAccountTD_out_Type.
     * 
    ...
    /**
     * Gets the accountInfo value for this RetrieveDepositAccountTD_out_Type.
     * 
     * @return accountInfo
     */
    ...
    /**
     * Sets the accountInfo value for this RetrieveDepositAccountTD_out_Type.
     * 
     * @param accountInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveDepositAccountTD_out_Type)) return false;
        RetrieveDepositAccountTD_out_Type other = (RetrieveDepositAccountTD_out_Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveDepositAccountTD_out_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("bian.scb.com.vn", "retrieveDepositAccountTD_out_Type"));
