/**
 * RetrieveCreditCardSumary_in_Type.java
 *
...
public class RetrieveCreditCardSumary_in_Type  implements java.io.Serializable {
    private vn.com.scb.bian.TransactionInfoType transactionInfo;

    private vn.com.scb.bian.CardInfoType cardInfo;

    public RetrieveCreditCardSumary_in_Type() {
    }
    ...
    /**
     * Gets the transactionInfo value for this RetrieveCreditCardSumary_in_Type.
     * 
    ...
    /**
     * Sets the transactionInfo value for this RetrieveCreditCardSumary_in_Type.
     * 
    ...
    /**
     * Gets the cardInfo value for this RetrieveCreditCardSumary_in_Type.
     * 
     * @return cardInfo
     */
    ...
    /**
     * Sets the cardInfo value for this RetrieveCreditCardSumary_in_Type.
     * 
     * @param cardInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetrieveCreditCardSumary_in_Type)) return false;
        RetrieveCreditCardSumary_in_Type other = (RetrieveCreditCardSumary_in_Type) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetrieveCreditCardSumary_in_Type.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("bian.scb.com.vn", "retrieveCreditCardSumary_in_Type"));
