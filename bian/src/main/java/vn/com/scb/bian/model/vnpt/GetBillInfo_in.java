...
public class GetBillInfo_in implements java.io.Serializable {
    ...
    public GetBillInfo_in(String transId, String customerCode, String province, String channel) {
        ...
        this.billPaymentInfo.setBillMoreInfomation(province);
    }
    
    public GetBillInfo_in(TransactionInfoType transactionInfo, BillPaymentInfoType billPaymentInfo) {
